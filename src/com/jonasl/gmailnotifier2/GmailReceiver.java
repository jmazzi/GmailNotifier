...
public class GmailReceiver extends BroadcastReceiver {
    ...
    private static boolean formatGmailStyle(Context context, String account, int unreadCount,
        ...
        try {
            ...
            String meString = context.getString(R.string.me);
            String draftString = context.getString(R.string.draft);
            String draftPluralString = context.getString(R.string.draftplural);
            String sendingString = context.getString(R.string.sending);
            String sendFailedString = context.getString(R.string.sendingfailed);
